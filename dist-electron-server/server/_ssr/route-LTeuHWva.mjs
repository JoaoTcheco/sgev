...
import { i as isDesktop, b as desktopSignOut } from "./router-DE-fAUtY.mjs";
import { u as useAuthUser, a as useUserRoles, b as useProfile, h as highestRole, r as roleLabel } from "./use-auth-ButDQezc.mjs";
...
import { P as Pill, a as LogOut, b as PanelLeft, X, c as LayoutDashboard, S as ShoppingCart, B as Banknote, R as Receipt, T as TriangleAlert, d as Package, e as PackagePlus, C as ChartColumn, W as Wallet, f as Truck, F as FileText, U as Users, H as History, g as Settings } from "../_libs/lucide-react.mjs";
...
const OPERATIONAL = [
  ...
  { title: "Alertas", url: "/alertas", icon: TriangleAlert, roles: ["admin", "pharmacist", "cashier"] },
  ...
  { title: "Estatísticas", url: "/estatisticas", icon: ChartColumn, roles: ["admin", "pharmacist"] }
];
const MANAGEMENT = [
...
function AppSidebar() {
  ...
  const visible = (items) => items.filter((i) => role && i.roles.includes(role));
  ...
  const renderGroup = (label, items) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: list.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuButton, { asChild: true, isActive: isActive(item.url), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: item.url, className: "flex items-center gap-3", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { collapsible: "icon", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarHeader, { className: "border-b border-sidebar-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-2 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-9 w-9 items-center justify-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { className: "h-5 w-5" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-tight", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-sidebar-foreground", children: "PharmaSys" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-sidebar-foreground/60", children: "Gestão Farmácia" })
      ] })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarFooter, { className: "border-t border-sidebar-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 px-2 py-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-tight", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate text-sm font-medium text-sidebar-foreground", children: profile?.full_name || user?.email || "Utilizador" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-sidebar-foreground/60", children: roleLabel(role) })
      ] }),
